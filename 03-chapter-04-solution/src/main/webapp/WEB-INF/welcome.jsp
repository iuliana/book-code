...
<table>
    <tr>
        ...
        <td> <h2>
            ...
            <h3>
                If you see this page, then your forth Spring Web application is working as intended
                </br>
                and your Java based annotated configuration without web.xml file is correct.
                <br/>
                Congratulations!
            </h3></td>
    </tr>
